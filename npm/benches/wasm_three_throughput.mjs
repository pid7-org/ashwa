/**
 * Ashwa searchThree Throughput & Latency Microbenchmark Suite (WebAssembly SIMD128)
 */

import { initSync, searchThree } from "@pid7/ashwa/browser";
...
export async function benchmarkTier(tier, haystack, needle) {
  ...
  while (
    ...
    blackHole = await searchThree(slice, needle);
    warmupIters++;
  }
...
export async function main() {
  const needle = new Uint8Array([0x0a, 0x0b, 0x0c]);
