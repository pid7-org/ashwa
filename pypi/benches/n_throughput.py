"""Ashwa search_n Throughput & Latency Microbenchmark Suite (Python / PyO3 Native C-Extension)"""
...
def benchmark_tier(tier: dict, haystack: bytearray, needle: bytes) -> dict:
    ...
    while (
        ...
        black_hole = search_n(view, needle)
        warmup_iters += 1
