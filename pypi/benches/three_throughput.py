"""Ashwa search_three Throughput & Latency Microbenchmark Suite (Python / PyO3 Native C-Extension)"""
...
def benchmark_tier(tier: dict, haystack: bytearray, needle: bytes) -> dict:
    ...
    search_three = ashwa.search_three
    ...
    while (
        ...
        black_hole = search_three(view, needle)
        warmup_iters += 1
